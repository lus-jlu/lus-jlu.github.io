...
## 【主讲课程】
+ 《程序设计基础》（原名：高级语言程序设计）（现为教学团队实践负责人）
...
5. Zhang Junwei, Han Shuai, Xiong Xi, Zhu Sheng, **Lü Shuai\***. Explorer-Actor-Critic: Better actors for deep reinforcement learning. **Information Sciences**, 2024. **(中科院1区TOP期刊, CCF推荐B类期刊, SCI, 目前IF: 8.1)**
6. **Lü Shuai**, Zhang Tongbo, Xu Yue, Zhou Wenbo, Lai Yong\*. Combining bounded solving and controllable randomization for approximate model counting. **Journal of Experimental & Theoretical Artificial Intelligence**, 2024. **(中科院4区期刊, CCF推荐C类期刊, SCI, 目前IF: 2.2)**
7. **Lü Shuai**, Li Zongze, Zhang Xinyu, Li Jingyao\*. Consistency regularization-based mutual alignment for source-free domain adaptation. **Expert Systems with Applications**, 2024, 241: 122577. **(中科院1区TOP期刊, CCF推荐C类期刊, SCI, 目前IF: 8.5)**
