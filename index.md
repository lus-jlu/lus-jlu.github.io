...
主要研究领域为人工智能、机器学习与自动推理。主持国家自然科学基金项目等科研项目13项，参加科研项目29项。在AAAI、IJCAI、Information Sciences、Expert Systems with Applications、计算机学报、软件学报等国内外期刊和会议上发表学术论文136篇，其中：SCI和EI检索学术论文105篇。获得全国商业科技进步一等奖3项、二等奖1项，吉林省自然科学二等奖1项，吉林省科学技术进步三等奖2项。
...
## 【科研论文】在AAAI、IJCAI、Information Sciences、Expert Systems with Applications、计算机学报、软件学报等国内外期刊和会议上发表学术论文136篇，其中：SCI和EI检索学术论文105篇。
...
7. Shu Man, **Lü Shuai\***, Gong Xiaoyu, An Daolong, Li Songlin. Episodic memory-double actor-critic twin delayed deep deterministic policy gradient. **Neural Networks**, 2025. **(中科院1区TOP期刊, CCF推荐B类期刊, SCI, 目前IF: 6.0)**
...
6. An Daolong, Shen Chun, Li Songlin, Xiao Wei, **Lü Shuai\***, Zhou Wenbo\*. Result constraint behavior clone for offline reinforcement learning. 2025. (Submitted)
7. Lin Dajun, Li Songlin, **Lü Shuai\***, Zhou Wenbo\*, Zhong Taihong, An Daolong. WCPC-TD3: Weighted contrastive policy constraint for offline reinforcement learning. 2025. (Submitted)
8. Li Jingyao, Li Zhanshan, **Lü Shuai\***. Target self-guided adaptation: A simple framework for unsupervised domain adaptation. 2025. (Submitted)
9. Zhong Taihong, **Lü Shuai\***, Lin Dajun, An Daolong. Mild conservatism Q-learning with adaptive Q-ensemble. 2025. (Submitted)
10. Wu Junhong, Liu Jie, **Lü Shuai\***. Alternate data augmentation for generalization in reinforcement learning. 2025. (Submitted)
...
13. Zhou Ruikai, Li Songlin, **Lü Shuai\***. From simple to complex: Mitigating the impact of critic accuracy fluctuations by multi-agent. 2025. (Submitted)
...
16. Zhang Yushu, Shen Chun, An Daolong, Wu Junhong, **Lü Shuai\***. Reinforcement learning with extreme minimum distribution. 2025. (Submitted)
...
18. Zhou Ruikai, Zhong Taihong, Zhu Wenbo, Han Shuai, **Lü Shuai\***. Influence of Gaussian distribution on performance metrics in continuous reinforcement learning: A case study. 2025. (Submitted)
