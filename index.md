...
DBLP: <A href="https://dblp.uni-trier.de/pid/27/10828-1" target="_blank">Shuai Lv 0001 (aka: Shuai Lü 0001, Shuai Lu 0001)</A>
...
7. Zhou Ruikai, Zhu Wenbo, Han Shuai, Kang Meng, **Lü Shuai\***. VCSAP: Online reinforcement learning exploration method based on visitation count of state-action pairs. **Neural Networks**, 2025. **(中科院1区TOP期刊, CCF推荐B类期刊, SCI, 目前IF: 6.0)**
...
20. Li Junjie, **Lü Shuai**, Li Jingyao, Zhou Wenbo*. IE-GAN: An improved evolutionary generative adversarial network using a new fitness function and a generic crossover operator. 2024. (Submitted)
