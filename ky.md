...
:-:|:-|:-:|:-:|:-:|:-:|:-:
1|ACM Transactions on Information Systems|数据挖掘A类|计算机科学2区|信息系统1区|计算机科学|ACM
2|ACM Transactions on Knowledge Discovery from Data|数据挖掘B类|计算机科学3区|信息系统3区<BR>软件工程3区|计算机科学|ACM
3|ACM Transactions on Multimedia Computing, Communications, and Applications|计算机图形学与多媒体B类<BR>计算机网络B类|计算机科学3区|信息系统3区<BR>理论方法2区<BR>软件工程3区|计算机科学|ACM
